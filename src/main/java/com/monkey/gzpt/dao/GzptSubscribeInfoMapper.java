...
public interface GzptSubscribeInfoMapper {
    ...
    List < GzptSubscribeInfo > selectByCustomerId(@Param("customerId") Long customerId);

    GzptSubscribeInfo selectByCustomerIdAndSubscribe(@Param("customerId") Long customerId);
    /**
     * 根据用户ID与openId查询
     * 
     * @param userName
     ...
     */
    GzptSubscribeInfo selectByCustomerIdAndOpenId(@Param("customerId") Long customerId, @Param("openId") String openId);
