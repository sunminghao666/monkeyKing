...
public class SmsUtil {
	...
	public static SendSmsResponse sendSms(String templateCode,
			String templateParam, String phone) throws ClientException {
		...
		IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou",
				ConfigInfo.getByProperties("sms.accessKeyId"),
				ConfigInfo.getByProperties("sms.accessKeySecret"));
		...
		Gson gson = new Gson();
		TAFLog.info(phone + "|" + templateCode + "|" + templateParam + "|"
	...
	public static void main(String[] args) throws ClientException,
		...
		msg.put("code", (int) ((Math.random() * 9 + 1) * 100000) + "");
		Gson gson = new Gson();
		SendSmsResponse response = sendSms("SMS_120545175", gson.toJson(msg),
				"18616270872");
