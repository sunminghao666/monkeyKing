	...
	function I(G, _) {
		...
		function E(F, E) {
			...
			var G = [
					...
					"</script><script src=", "../component/WDatePicker/", "lang/", H.name,".js charset=", H.charset, "></script>" ];
			for (var I = 0; I < C.length; I++)
				if (C[I].name == E.skin)
					G.push("<link rel=\"stylesheet\" type=\"text/css\" href=\""
							+ "../component/WDatePicker/" + "skin/" + C[I].name
							+ "/datepicker.css\" charset=\"" + C[I].charset
							+ "\"/>");
			G.push("<script type=\"text/javascript\" src=\""
							+ "../component/WDatePicker/calendar.js?\"+Math.random()+\" charset=\"gb2312\"></script>");
