...
//            if(""===b)
//            	return this.$link_wrapper.find("input.f-lu").addClass("fr-error").focus(),
...
//            		e===!0?l.attr("target","_blank"):l.removeAttr("target"),
//            		f===!0?l.attr("rel","nofollow"):l.removeAttr("rel"),
//            		l.removeClass(Object.keys(this.options.linkClasses).join(" ")),
//            		l.attr("href",b).addClass(d)}
//            	    this.triggerEvent("imageLinkInserted",[b]),
//            	    this.saveUndoStep(),this.showImageEditor(),
//            	    this.$element.find(".f-img-editor").find("img").click(),
//            	    this.link=!1}
//            else{
//            	var m=null;
//            	this.isLink?""===c&&(c=this.$element.text()):(
//            			this.restoreSelection(),
//            			g=this.getSelectionLinks(),
//            			g.length>0&&(m=g[0].attributes,
//            			is_file=a(g[0]).hasClass("fr-file")),
//            			this.saveSelectionByMarkers(),document.execCommand("unlink",!1,b),
//            			this.$element.find('span[data - fr - link = "true"]').each(function(b,c){a(c).replaceWith(a(c).html())}),
//            			this.restoreSelectionByMarkers()),
//            			this.isLink?(this.$element.text(c),g=[this.$element.attr("href",b).get(0)]):(this.removeMarkers(),
